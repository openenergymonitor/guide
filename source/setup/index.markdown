...
<label class='menu-selector energy' for='home-energy-hardware'><strong>Home Energy<br> Monitoring<br><i class="icon-arrow-down"></i></strong></label>
&nbsp;&nbsp;
<label class='menu-selector solarpv' for='solar-pv-hardware'><strong>Solar PV<br> Monitoring<br><i class="icon-arrow-down"></i></strong></label>
&nbsp;&nbsp;
...
<div style="background-color:#F0F0F0;padding:10px;">
  <div class="install-instructions energy">
    ...
    <ul>
      ...
      <li>Runs the same <a href="https://github.com/openenergymonitor/emonpi/wiki/emonSD-pre-built-SD-card-Download-&amp;-Change-Log">software stack</a> as the emonPi</li>
...
<div class="install-instructions solarpv">
  <h3 id="a-classtitle-link-namesolar-pv-hardware-hrefsolar-pv-hardwarea-solar-pv-hardware">
  ...
  <ul>
    <li>2 X <a href="https://shop.openenergymonitor.com/100a-max-clip-on-current-sensor-ct/">Clip-on CT sensors</a> (included in emonPi solar PV bundle)</li>
    <li>1 x <a href="https://shop.openenergymonitor.com/components/">AC-AC voltage sensor adapter</a> (included in emonPi solar PV bundle)</li>
  </ul>
...
<div class="install-instructions temperature" style="border-style: none;">
    ...
    <h3><a class="title-link" name="temperature--humidity-sensors" href="#temperature--humidity-sensors"></a>3. Temperature &amp; Humidity Monitoring</h3>
    
    <p><img src="/images/setup/temp-dash.png" alt="Temperature monitoring example"></p>
    ...
    <p><img src="/images/setup/emonth-plant.png" alt="emonTH" title="emonTH"></p>
    ...
    <ul>
      ...
      <li>Sensor wire can be extended using RJ45 cable and <a href="http://shop.openenergymonitor.com/rj45-extender/">RJ45 Extender</a></li>
    </ul>
    ...
    <ul>
      ...
      <li>Compatible with emonPi using <a href="http://shop.openenergymonitor.com/rj45-to-terminal-block-breakout-for-ds18b20/">RJ45 Breakout</a></li>
      <li>Up to 6 sensors can be connected to emonPi / emonTx using <a href="http://shop.openenergymonitor.com/rj45-to-terminal-block-breakout-for-ds18b20/">RJ45 Breakout</a></li>
    </ul>
