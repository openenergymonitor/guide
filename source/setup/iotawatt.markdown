...
## {% linkable_title **1. Clip-on Current Sensor (CT)** %}
...
## {% linkable_title **2. AC-AC Voltage Sensor Adapter (VT)** %}
...
### 2. Confugure Current Transformer(s (CT's)
...
For technical IoTaWatt documentation see [IoTaWatt GitHub repo Wiki.](https://learn.openenergymonitor.org/electricity-monitoring/ct-sensors/installation)
