...
<ul class='divided sidebar-menu'>
  <li style="padding-top: 10px;">
    ...
    <ul>
      ...
      <li><a  href='<?php echo $path; ?>setup/local/'>2. Log Locally </a></li>
      <li><a  href='<?php echo $path; ?>setup/remote/'>3. Log Remotely </a></li>
    ...
    <b>Emoncms</b>
    <ul>
      <li><a  href='<?php echo $path; ?>emoncms/coreconcepts/'>Core Concepts </a></li>
      <li><a  href='<?php echo $path; ?>emoncms/postingdata/'>Posting data </a></li>
      <li><a  href='<?php echo $path; ?>emoncms/graphs/'>View Graphs </a></li>
      <li><a  href='<?php echo $path; ?>emoncms/dashboards/'>Dashboard builder </a></li>
