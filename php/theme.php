  ...
  <div class='section'>
    ...
    <ul class='divided sidebar-menu'>
      <li style="padding-top: 10px;">
          <b>Setup</b>
        <ul>
          <li><a  href='<?php echo $path; ?>setup/index'>1. System Overview </a></li>
          <li><a class='active' href='<?php echo $path; ?>setup/connect/'>2. Connect </a></li>
          <li><a  href='<?php echo $path; ?>setup/install/'>3. Install </a></li>
          <li><a  href='<?php echo $path; ?>setup/local/'>4. Log Locally </a></li>
          <li><a  href='<?php echo $path; ?>setup/remote/'>5. Log Remotely </a></li>
          <li><a  href='<?php echo $path; ?>setup/dashboards/'>6. Dashboards </a></li>
          <li><a  href='<?php echo $path; ?>setup/energy-node/'>7. Energy Sensing Node(s) </a></li>
          <ul style="margin-bottom: 0px;;">
            <li><a  href='<?php echo $path; ?>setup/emontx/'>emonTx </a></li>
          </ul>
          <li><a  href='<?php echo $path; ?>setup/emonth/'>8. Temperature Node(s) </a></li>
          <li><a  href='<?php echo $path; ?>setup/optical-pulse-sensor/'>9. Add Optical Pulse Sensor </a></li>
          <li><a  href='<?php echo $path; ?>setup/import/'>10. Import / Backup </a></li>
          <li><a  href='<?php echo $path; ?>setup/north-america/'>11. Use in North America </a></li>
          <li><a  href='<?php echo $path; ?>setup/troubleshooting/'>12. Troubleshooting </a></li>
          <li><a  href='<?php echo $path; ?>setup/remote-access/'>13. Remote Access </a></li>
          <li><a  href='<?php echo $path; ?>setup/update/'>14. Update & Upgrade </a></li>

        </ul>
        <li>
          <b>Emoncms</b>
          <ul>
          <li><a  href='<?php echo $path; ?>setup/emoncms-graphs/'>View Graphs </a></li>
          <li><a  href='<?php echo $path; ?>setup/daily-kwh/'>Daily kWh </a></li>
          <li><a  href='<?php echo $path; ?>setup/daily-averages/'>Daily Averages </a></li>
          <li><a  href='<?php echo $path; ?>setup/export-csv/'>Exporting CSV </a></li>
          <li><a  href='<?php echo $path; ?>setup/histograms/'>Histograms </a></li>
